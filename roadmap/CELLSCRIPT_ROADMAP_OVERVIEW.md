...
| v0.16 release scope | Devnet-accepted on `nightly-0.16` for the scoped metadata/tooling release. Adds operational semantics, ProofPlan soundness, builder assumptions, schema-bound transaction validation, solver templates, deployment governance, audit tooling, descriptive standard CKB compatibility fixtures, the P0/key P1 compiler-hardening gate, and proposal-local NovaSeal devnet/profile certification. | [v0.16 roadmap](CELLSCRIPT_0_16_ROADMAP.md), [v0.16 release notes draft](../docs/releases/CELLSCRIPT_0_16_RELEASE_NOTES_DRAFT.md) |
...
| v0.16 | Metadata Assurance and Production Tooling Skeleton | "Make assumptions explicit and auditable." | Devnet-accepted on `nightly-0.16` |
