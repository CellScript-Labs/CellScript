...
| `../../../target/debug/cellc certify --plugin novaseal-profile-v0 --json` | passed local Rust compiler-hosted production-prep and profile certification gates, including `agreement_profile_public_ecosystem_certification_v0`; external production attestations and public BTC SPV evidence still required |
...
profiles, and external BIP340 TCB review remain
production blockers.
...
named by `target/novaseal-production-gates.json` are present and
