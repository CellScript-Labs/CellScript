...
[`CELLSCRIPT_EXAMPLE_BUSINESS_FLOWS.md`](https://github.com/CellScript-Labs/CellScript/blob/0.30/docs/CELLSCRIPT_EXAMPLE_BUSINESS_FLOWS.md).
For a concrete token-to-AMM builder path with entry witness commands, see
[`token_amm_bootstrap.md`](https://github.com/CellScript-Labs/CellScript/blob/0.30/docs/examples/token_amm_bootstrap.md).
